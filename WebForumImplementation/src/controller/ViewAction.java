...
public class ViewAction extends Action {
    ...
    public String perform(HttpServletRequest request) {
		...
		try {
    		...
    		//request.setAttribute("sellerName", p.getOwner());
    		//request.setAttribute("price", p.getPrices());
    		//request.setAttribute("listingDate", p.getListingDate());
    		//request.setAttribute("sellerEmail", p.getOwnerEmail());
